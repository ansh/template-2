...
You must respond in exactly this format. NEVER include quotes.  
PROMPT_A_CAPTIONS:
CAPTION1: [caption 1 text]
CAPTION2: [caption 2 text]
CAPTION3: [caption 3 text]`;
...
You must respond in exactly this format, and NEVER include quotes. And remember, the caption + video must make sense ONE ITS OWN without any information about the input::
PROMPT_B_CAPTIONS:
CAPTION1: [caption 1 text]
CAPTION2: [caption 2 text]
CAPTION3: [caption 3 text]`;
